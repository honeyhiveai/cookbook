...
| [`config-as-code/`](config-as-code/) | Reference — tracing + **`.honeyhive/`** eval config + **`evaluate.py`**. Run evals here. |
...
- **Running evals or checking a known-good integration?** → [`config-as-code/`](config-as-code/)
